...
final class ItemSearchTableViewCell: UITableViewCell {
    ...
    func configData(model: ItemSearchMediaViewModel) {
    ...
    private func setImage( viewModel: ItemSearchMediaViewModel) {
...
extension ItemSearchTableViewCell: Reusable { }
